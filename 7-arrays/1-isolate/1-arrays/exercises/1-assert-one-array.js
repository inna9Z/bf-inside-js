...
console.assert(complicated.length === 4, 'Test 4: length');
console.assert(complicated[0] === 'a', 'Test 4: a');
console.assert(complicated[1] === 'b', 'Test 4: b');
console.assert(complicated[2] === 'c', 'Test 4: c');
console.assert(complicated[3] === 'e', 'Test 4: d');
console.assert(complicated[4] === 'f', 'Test 4: e');
